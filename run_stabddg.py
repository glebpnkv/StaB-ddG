...
if __name__ == "__main__":
    ...
    argparser.add_argument("--pdb_cache_path", type=str, default="")
    ...
    dataset = SKEMPIDataset(pdb_dir=args.pdb_dir, csv_path=args.csv_path, pdb_dict_cache_path=args.pdb_cache_path)
    ...
    print(f'Saved predictions to {os.path.join(args.output_dir, f"{args.run_name}.csv")}')